...
{
  public class VehicleAttributeViewModel : ViewModelBase
  {
    public VehicleAttributeViewModel(string assetsPrefix)
      : base(assetsPrefix)
    {
    }

    public VehicleAttributeViewModel(string assetsPrefix, IMetadata metadata)
