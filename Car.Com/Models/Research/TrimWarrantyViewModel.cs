...
{
  public class TrimWarrantyViewModel : ViewModelBase
  {
    public TrimWarrantyViewModel(string assetsPrefix)
      : base(assetsPrefix)
    {
    }

    public TrimWarrantyViewModel(string assetsPrefix, IMetadata metadata)
    ...
    public IEnumerable<Dto.Specifications> WarrantyItems { get; set; }
